...
printf("\n B+ TREE INSERTION AND DISPLAY OF REQUIRED ORDER \n");
...
printf(" 1. Enter elements one by one 2. Randomn insertion \n choice: ");
scanf("%d",&mch);
...
if(mch==1)
  ...
  {    
	...
	if(ch==1)
	{
	 ...
	 printf("\n\nLeaf Level display to show the working of sibling pointer\n");
...
printf("\nEnter the number of randomn elements\n");
scanf("%d",&n);
